...
defined('REGEXP_ZHCN_CID') OR define('REGEXP_ZHCN_CID', "/^(\d{6})(\d{4})(\d{2})(\d{2})(\d{3})([0-9]|X|x)$/"); // 中国身份证号码
defined('REGEXP_ZHCN_PHONE') OR define('REGEXP_ZHCN_PHONE', "/^1[34578]\d{9}$/"); // 中国大陆手机号码
defined('REGEXP_ZHCN_POSTCODE') OR define('REGEXP_ZHCN_POSTCODE', "/^[1-9]\d{5}(?!\d)$/"); // 中国邮政编码
defined('REGEXP_ZHCN_TEL') OR define('REGEXP_ZHCN_TEL', "/\d{3}-\d{8}|\d{4}-\d{7,8}/"); // 中国座机号码
defined('REGEXP_ZHCN_UTF8') OR define('REGEXP_ZHCN_UTF8', "/[\u4e00-\u9fa5]/"); // 中文字符utf-8编码
